...
function install_helm_cli {
  version="${HELM_CLI_VERSION:-v2.16.3}"
  os="${OS:-linux}"
  arch="${ARCH:-${arch}}"
  file="helm.tar.gz"
  trap "{ rm -f $file ; exit 255; }" EXIT
...
function install_tools {
  ...
  logGreen "Start: Installing: Terraform"
  # install_terraform
  # logGreen "End: Installing: Terraform"

  # logGreen "Start: Installing: Pivnet CLI"
  # install_pivnet_cli
  # logGreen "End: Installing: Pivnet CLI"

  # logGreen "Start: Installing: jq"
  # install_jq
  # logGreen "End: Installing: jq"

  # logGreen "Start: Installing: OM"
  # install_om
  # logGreen "End: Installing: OM"

  # logGreen "Start: Installing: Credhub"
  # install_credhub
  # logGreen "End: Installing: Credhub"

  # # install_govc

  # logGreen "Start: Installing: Helm CLI"
  # install_helm_cli
  # logGreen "End: Installing: Helm CLI"

  # logGreen "Start: Installing: BOSH CLI"
  # install_bosh_cli
  # logGreen "End: Installing: BOSH CLI"


  # logGreen "Start: Installing: PKS CLI"
  # install_pks_cli
  # logGreen "End: Installing: PKS CLI"

  # logGreen "Start: Installing: PKS Cleanup"
  # install_pks_cleanup
